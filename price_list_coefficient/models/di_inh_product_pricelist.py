...
class PricelistItem(models.Model):
    ...
    di_incrcoef = fields.Float(string="Increase coefficient", help=""" Increase coefficient applied on base price """, digits=(5,2))
            ...
            for rule in items:
                ...
                if price is not False:
                    if rule.compute_price == 'fixed':
                        ...
                        price_limit = price
                        # difmiadi
                        if rule.di_incrcoef and rule.di_incrcoef!=0:
                            price = price*rule.di_incrcoef
